...
<View style={styles.card}>
        ...
        <View style={{marginTop: 20}}>
          <Text style={{color: '#000', fontWeight: 'bold', marginBottom: 5}}>Help overcome malnutrition</Text>
          <Text>
      ...
      <View style={styles.card}>
        ...
        />
        <View style={{marginTop: 20}}>
          <Text style={{color: '#000', fontWeight: 'bold', marginBottom: 5}}>Help Improve Child Health</Text>
          <Text>
      ...
      <View style={styles.card}>
        ...
        />
        <View style={{marginTop: 20}}>
          <Text style={{color: '#000', fontWeight: 'bold', marginBottom: 5}}>Help Improve Healthy Food</Text>
          <Text>
            <Text style={{color: '#6bd19b'}}>$2277 </Text>
            <Text>Funds raised from $6310</Text>
          </Text>
