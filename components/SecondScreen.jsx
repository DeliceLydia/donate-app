    ...
    return (
        <View style={{ paddingHorizontal: 30, paddingVertical: 20, width: width, height: height }}>
            ...
            <View style={{ paddingVertical: 40, display: 'flex', alignItems: 'center', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <Image style={{ width: 300, height: 250, }} source={require('../assets/second.png')} />

            </View>
            <View style={{ paddingVertical: 30 }}>

                <Text style={{ textAlign: 'center', fontSize: 25, fontWeight: '800', color: '#64cd91', paddingVertical: 15, }}>Create your own fundraising and publish it to the world </Text>
